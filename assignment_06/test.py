...
while not game_over:
    ...
    # valid_location = get_valid_location(game)
    # print("valid location",valid_location)
    # print("depth",depth)
    # if depth == 0 or is_board_full(game) or is_game_over():
    #     if is_board_full(game) or is_game_over():
    #         if is_game_over() == 2:
    #             return (None, 100000000000000)
    #         elif is_game_over() == 1:
    #             return (None, -10000000000000)
    ...
    #         print(game)
    #         br_copy = game.copy()
    #         new_score = minimax(br_copy,depth-1,False)[1]
    #         if new_score > value:
    #             value = new_score
    #             column = col
    #     return column, value
    ...
    #     for col in valid_location:
    #         row = get_next_open_row(game, col)
    #         drop_piece(game, row, col, PLAYER_PIECE)
    #         print(game)
...
# while (not game.is_game_over()) or (not game.is_board_full()):
    #     # print(game._board)
    #     if turn == 0:
    #         col = int(input("Player 1 make your selection: "))
    #         player = 1
    #         game.insert_coin(player,col)
    #         game.print_board()

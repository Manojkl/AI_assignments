[![Build Status](https://travis-ci.org/hbrs-ai/assignment-05.svg?branch=master)](https://travis-ci.org/hbrs-ai/assignment-05)

# <YOUR_FIRST_NAME><YOUR_LAST_NAME>

# Assignment 6
In this Assignment you will be implementing the minimax algorithm with and without alpha-beta pruning for the Connect-4 game.
...
* **Travis build** can be ignored for this assignment, since an interactive user interface is required.
...
## Deliverables
* Please provide an interactive interface where input from the human player is received from the keyboard and the moves in the board by the human/AI agent are printed on the screen everytime.
